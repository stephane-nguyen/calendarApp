...
public class Exam implements Serializable{
	...
	public Exam(Date startDate, Integer duration, Integer subjects_id_subjects, Integer room_id_room) {
	...
	public String toString() {
		return "Exam [idExam=" + id_exam + ", duration=" + duration + ", subject_id_subject=" + subjects_id_subjects + ", room_id_room="
